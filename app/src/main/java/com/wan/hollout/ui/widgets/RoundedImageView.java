...
public class RoundedImageView extends DynamicHeightImageView {
    ...
    private Drawable resolveResource() {
        ...
        if (mResource != 0) {
            try {
                ...
                HolloutLogger.w(TAG, "Unable to find resource: " + mResource);
                // Don't try again.
                mResource = 0;
            }
        }
     ...
     * @return the radius.
     */
    public float getCornerRadius(@HolloutRoundedImageCorner int corner) {
     ...
     */
    public void setCornerRadiusDimen(@HolloutRoundedImageCorner int corner, @DimenRes int resId) {
     ...
     */
    public void setCornerRadius(@HolloutRoundedImageCorner int corner, float radius) {
    ...
    public void setCornerRadius(float topLeft, float topRight, float bottomLeft, float bottomRight) {
        if (mCornerRadii[HolloutRoundedImageCorner.TOP_LEFT] == topLeft
                && mCornerRadii[HolloutRoundedImageCorner.TOP_RIGHT] == topRight
                && mCornerRadii[HolloutRoundedImageCorner.BOTTOM_RIGHT] == bottomRight
                && mCornerRadii[HolloutRoundedImageCorner.BOTTOM_LEFT] == bottomLeft) {
            return;
        }

        mCornerRadii[HolloutRoundedImageCorner.TOP_LEFT] = topLeft;
        mCornerRadii[HolloutRoundedImageCorner.TOP_RIGHT] = topRight;
        mCornerRadii[HolloutRoundedImageCorner.BOTTOM_LEFT] = bottomLeft;
        mCornerRadii[HolloutRoundedImageCorner.BOTTOM_RIGHT] = bottomRight;
