...
import com.wan.hollout.ui.widgets.chatmessageview.util.ViewUtil;
...
public class ChatMessageView extends RelativeLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        try {
            viewPartMain = (TextView) this.findViewById(a.getResourceId(R.styleable.ChatMessageView_viewPartMain, -1));
            viewPartSlave = this.findViewById(a.getResourceId(R.styleable.ChatMessageView_viewPartSlave, -1));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
