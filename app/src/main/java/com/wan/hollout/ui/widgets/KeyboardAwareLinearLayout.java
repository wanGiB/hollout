...
import com.wan.hollout.utils.ServiceUtil;
...
public class KeyboardAwareLinearLayout extends LinearLayoutCompat {
  ...
  private int getKeyboardPortraitHeight() {
    ...
    return HolloutUtils.clamp(keyboardHeight, minCustomKeyboardSize, getRootView().getHeight() - minCustomKeyboardTopMargin);
  }
