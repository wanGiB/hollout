...
public class SimpleTextView extends View implements Drawable.Callback {
    ...
    private int gravity = Gravity.LEFT | Gravity.START | Gravity.TOP;
    private CharSequence text;
    private Drawable leftDrawable;
    private Drawable rightDrawable;
    private int drawablePadding = HolloutUtils.dp(4);
    ...
    public void setTextSize(int size) {
        int newSize = HolloutUtils.dp(size);
    ...
    private boolean createLayout(int width) {
        if (text != null) {
            try {
                ...
                layout = new StaticLayout(string, 0, string.length(), textPaint, width + HolloutUtils.dp(8), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                calcOffset(width);
            } catch (Exception e) {
                //ignore
            }
