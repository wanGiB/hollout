...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private View suppressableView;

    public void setSuppressableView(View suppressableView) {
        this.suppressableView = suppressableView;
    }

    public View getSuppressableView() {
        return suppressableView;
    }
    ...
    private void initStyle(AttributeSet attrs, int defStyleAttr) {
        if (!isInEditMode()) {
            ...
            if (a != null) {
                ...
                if (a.hasValue(R.styleable.MaterialSearchView_showSearch)) {
    ...
    private void initiateView() {
        if (!isInEditMode()) {
            ...
            mSuggestionsListView.requestDisallowInterceptTouchEvent(true);
    ...
    private void setVisibleWithAnimation() {
        UiUtils.AnimationListener animationListener = new UiUtils.AnimationListener() {
            @Override
