...
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.cache.ViewCacheFactory;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.gravity.CenterChildGravity;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.gravity.CustomGravityResolver;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.gravity.IChildGravityResolver;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.layouter.AbstractPositionIterator;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.layouter.ColumnsStateFactory;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.layouter.ICanvas;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.layouter.ILayouter;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.layouter.IMeasureSupporter;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.layouter.IStateFactory;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.layouter.LayouterFactory;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.layouter.MeasureSupporter;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.layouter.RowsStateFactory;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.layouter.breaker.EmptyRowBreaker;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.layouter.breaker.IRowBreaker;
...
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.layouter.criteria.InfiniteCriteriaFactory;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.layouter.placer.PlacerFactory;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.util.AssertionUtils;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.util.LayoutManagerUtil;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.util.log.IFillLogger;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.util.log.Log;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.util.log.LogSwitcherFactory;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.util.log.LoggerFactory;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.util.testing.EmptySpy;
import com.wan.hollout.ui.layoutmanagers.chipslayoutmanager.util.testing.ISpy;
...
public class ChipsLayoutManager extends RecyclerView.LayoutManager implements IChipsLayoutManagerContract,
    ...
    private void fill(RecyclerView.Recycler recycler, ILayouter backwardLayouter, ILayouter forwardLayouter) {
        ...
        */
            ...
            HolloutLogger.d("ChipsLayoutManager", e.getMessage());
        }
    }
